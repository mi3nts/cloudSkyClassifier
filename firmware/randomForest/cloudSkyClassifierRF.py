...
def main():
    ...
    print('-----------------------------------------------------')
    imagePath =  input('Enter the path to image file: ')
    print('-----------------------------------------------------')
    # dataFolder    = '../../../data/'
    ...
    onboardCapture = False
    # currentImage,imagePath =  getSnapShot(subFolder)

    currentImage,imagePath =  getSnapShotFromPath(imagePath)

    start = time.time()

    modelName = input('Enter the path to model file: ')
    print('-----------------------------------------------------')
    oneDImage, imageShape = generateFeatures(inputImage,imagePath)
...
# Printing the Average Pixel values for each Color
    ...
    print("Multi-scale Integrated Sensing and Simulation (MINTS)")
    print('-----------------------------------------------------')
    print("Prediction Accuracy  :  "+str(percentageAccuracy)+"%")
    print("------------------------------")
