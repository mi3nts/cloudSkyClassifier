...
if __name__ == '__main__':
    ...
    print('-----------------------------------------------------')
    print("-Cloud Sky Classifier - Testing - Naive Bayes Model -")
    print('-----------------------------------------------------')
    ...
    Confusion_Matrix_Testing_NB = confusion_matrix(All_Targets_Testing,testingPrediction)

    print("Confusion Matrix for Naive Bayes Classifier - Testing")
    print(Confusion_Matrix_Testing_NB)
    print('-----------------------------------------------------')


    testingAccuracy  =round((Confusion_Matrix_Testing_NB[0][0]+ Confusion_Matrix_Testing_NB[1][1]) \
                           /(Confusion_Matrix_Testing_NB[0][0]+ Confusion_Matrix_Testing_NB[1][1] + \
                             Confusion_Matrix_Testing_NB[0][1]+ Confusion_Matrix_Testing_NB[1][0]),4)
    print("Testing Accuracy for Naive Bayes Classifier: "+str(round(testingAccuracy*100,2))+"%" )
    print("-----------------------------------------------------")
    print('Testing Done.........................................')
    print("-----------------------------------------------------")
    print("Multi-scale Integrated Sensing and Simulation (MINTS)")
