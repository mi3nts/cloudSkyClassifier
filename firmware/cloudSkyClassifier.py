...
def main():
 ...
 ## Now the Focus will be to get back the Predicted Binary Image
    ...
    # 
    # Des_Binary = os.path.splitext(path_src)[0] +"_Classified_Binary_Image" + ".png"
    # # Des_Cloud = os.path.splitext(path_src)[0]+"_Classified_Cloud_Only_Image" + ".png"
    # # Des_Sky = os.path.splitext(path_src)[0] +"_Classsified_GT_Sky_Only_" + ".png"
    #
    # Binary_Image = Binary_Image_Writer(Prediction,(Shape[0],Shape[1]), Des_Binary)
    # Original_Image = cv2.imread(path_src)
    # Only_Cloud = Cloud_Only_Image_Writer(Original_Image, Binary_Image, Des_Cloud)
    #
    #
    # Only_Sky = Sky_Only_Image_Writer(Original_Image, Binary_Image, Des_Sky)
    #
    # # Arranging the Outputs
    # Cloud_Percentage = sum(Prediction)/len(Prediction)
    #
    ...
    #
    # print("Percentage of Clouds: ",Cloud_Percentage[0,0],'%')
...
def getSnapShot(folderIn):
    ...
    imageName =  folderIn+ 'teamLarySky-' +getDateTimeString(now)+'.png'
    # imageName = "lk.png"
    print(imageName)
...
def writeBinaryImage(Pixel_Row ,Image_Shape,Des_Path):
